...
const $ = etch.dom;
const HostPortalBindingComponent = require('./portals/host-portal-binding-component');
const GuestPortalBindingComponent = require('./portals/guest-portal-binding-component');
const JoinPortalComponent = require('./portals/join-portal-component');
